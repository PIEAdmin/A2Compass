...
const DEMO_DATA: Record<string, GameState> = {
  ...
  'drag-drop-sort': {
    ...
    data: {
      ...
      items: [
        { id: 'i1', label: 'Apple', emoji: '🍎', correctCategoryId: 'fruits' },
        { id: 'i2', label: 'Dog', emoji: '🐕', correctCategoryId: 'animals' },
        { id: 'i3', label: 'Red', emoji: '🔴', correctCategoryId: 'colors' },
        { id: 'i4', label: 'Banana', emoji: '🍌', correctCategoryId: 'fruits' },
        { id: 'i5', label: 'Cat', emoji: '🐱', correctCategoryId: 'animals' },
        { id: 'i6', label: 'Blue', emoji: '🔵', correctCategoryId: 'colors' },
        { id: 'i7', label: 'Orange', emoji: '🍊', correctCategoryId: 'fruits' },
        { id: 'i8', label: 'Fish', emoji: '🐟', correctCategoryId: 'animals' },
        { id: 'i9', label: 'Green', emoji: '🟢', correctCategoryId: 'colors' },
      ],
    },
  },
  'matching-pairs': {
