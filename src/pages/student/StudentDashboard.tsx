  ...
  return (
    <div className="tier-bg min-h-screen dashboard-main-content">
      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 py-4 space-y-4">
        ...
        {/* ════════ TODAY'S BOARD (Chalkboard) ════════ */}
        <section className="anim-card-enter" style={{ animationDelay: '0.22s' }}>
          <div className="relative rounded-2xl p-5 text-white overflow-hidden" style={{ background: 'linear-gradient(135deg, #2d5016, #1a3a0a)' }}>
            <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'url("data:image/svg+xml,%3Csvg width=\'40\' height=\'40\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cpath d=\'M0 0h40v40H0z\' fill=\'none\'/%3E%3Cpath d=\'M0 20h40M20 0v40\' stroke=\'%23fff\' stroke-width=\'0.5\'/%3E%3C/svg%3E")' }} />
            <div className="relative z-10">
              <div className="flex items-center justify-between flex-wrap gap-2">
                <div>
                  <p className="text-white/70 text-xs font-medium tracking-wider uppercase" style={{ fontFamily: "'Caveat', cursive, sans-serif" }}>Today is</p>
                  <h2 className="text-2xl font-bold" style={{ fontFamily: "'Caveat', cursive, sans-serif" }}>{dayOfWeek}</h2>
                  <p className="text-white/80 text-sm">{dateDisplay}</p>
                </div>
                <div className="text-right">
                  <span className="text-3xl font-bold tabular-nums" style={{ fontFamily: "'Caveat', cursive, sans-serif" }}>{timeDisplay}</span>
                  <p className="text-white/60 text-xs">🕐 Current Time</p>
                </div>
              </div>
            </div>
            <div className="absolute bottom-1 right-3 text-white/20 text-[10px]">📖 A² Compass</div>
          </div>
        </section>
        ...
        {scheduleData && (
          <section className="anim-card-enter" style={{ animationDelay: '0.55s' }}>
            <ReadAloud text="Your schedule for today" showIcon={true} iconSize="sm">
              <h2 className="text-xl font-display font-bold mb-3 flex items-center gap-2" style={{ color: theme.primary }}>
                📅 Your Schedule
              </h2>
            </ReadAloud>
            <div className="dashboard-card bg-white p-4">
              <div className="flex items-center justify-between text-center">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[10px] text-gray-400">Begin</span>
                </div>
